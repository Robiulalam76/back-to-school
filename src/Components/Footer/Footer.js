    ...
    return (
        <div>
            <footer className="px-4 divide-y bg-gray-800 text-gray-100">
                    ...
                    <div className="lg:w-1/3">
                        <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                            <div className="flex items-center justify-center w-12 h-12 rounded-full bg-violet-400">
                                <div className="flex-shrink-0 w-5 h-5 rounded-full text-gray-900">
                                    <img src="favicon.ico" alt="" />
                                </div>
                            </div>
                            <span className="self-center text-2xl font-semibold">BACK TO SCHOOL</span>
                        </a>
                    </div>
                    <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="flex justify-start space-x-3">
                                <a rel="noopener noreferrer" href="https://web.facebook.com/Robiulalam76/" title="Facebook" className="flex items-center p-1">
                ...
                <div className="py-6 text-sm text-center text-gray-400"><a href="https://www.linkedin.com/in/robiulalam762/">© back to school. All rights reserved.</a></div>
            </footer>
        </div>
    );
};
